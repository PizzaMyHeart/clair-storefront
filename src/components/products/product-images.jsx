...
const ProductImages = ({ images = [] }) => {
  ...
  return (
    <div className="flex">
      <div className="hidden lg:block flex-col items-center mr-4 overflow-y-scroll max-h-[50rem] w-[10em]">
      ...
      <div className="relative h-auto w-full max-h-[50rem] flex rounded-lg overflow-hidden">
