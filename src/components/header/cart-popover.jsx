...
const CartPopover = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <PopoverTransition>
        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-96 max-h-screen overflow-y-auto px-6 py-4 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            {cart.items < 1 ? (
